...
mglCommand mgls_set_cmd[] = {
	...
	{"inplot",_("Set position of plot in picture"),"x1 x2 y1 y2 [rel]", mgls_inplot ,5},
	...
	{"mask",_("Set brush for given mask"),"mask 'id' 'val'|'id' val|angle", mgls_mask ,2},
	{"meshnum",_("Set number of lines in mesh/fall/vect and so on"),"meshnum val", mgls_meshnum ,2},
	{"multiplot",_("Set position of plot"),"multiplot m n pos dx dy 'style' [sx sy]", mgls_multiplot ,5},
	...
	{"pendelta",_("Set size of semi-transparent area"),"pendelta val", mgls_pendelta ,2},
	...
	{"subplot",_("Set position of plot"),"subplot m n pos ['style' dx dy]", mgls_subplot ,5},
