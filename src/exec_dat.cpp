...
mglCommand mgls_dat_cmd[] = {
	...
	{"apde","Solve PDE using advanced method (X-Y only)","apde Res 'ham' IniRe IniIm [dz k0]", mgls_apde ,4},
	...
	{"copy","Copy data from another variable","copy Dat1 Dat2 ['eq']|ReDat ImDat Cdat|Dat val|Dat 'name'", mgls_copy ,4},
	...
	{"new","Create new data","new Dat nx ['eq']|Dat nx ny ['eq']|Dat nx ny nz ['eq']", mgls_new ,4},
	...
	{"save","Save data to file","save Dat 'file'|'str' 'file' ['how']", mgls_save ,3},
	...
	{"squeeze","Squeeze data","squeeze Dat kx [ky kz smooth]", mgls_squeeze ,3},
