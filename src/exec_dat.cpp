...
mglCommand mgls_dat_cmd[] = {
	...
	{"cumsum",_("Cumulative summation"),"cumsum Dat 'dir'", mgls_cumsum ,16},
	...
	{"export",_("Export data to PNG picture"),"export Dat 'fname' 'sch' [v1 v2]", mgls_export ,3},
	...
	{"import",_("Import data from PNG picture"),"import Dat 'fname' 'scheme' [v1 v2]", mgls_import ,4},
	...
	{"integrate",_("Integrate data"),"integrate Dat 'dir'", mgls_integrate ,16},
	...
	{"readhdf",_("Read data from HDF5 file"),"readhdf Dat 'file' 'id'", mgls_readhdf ,4},
	...
	{"section",_("Extract sub-array"),"section Res Dat id ['dir' val]|Res Dat Ids ['dir' val]", mgls_section ,4},
	...
	{"solve",_("Find root Dat_{i,j,k}=val (inverse evaluate)"),"solve Res Dat val 'dir' [Idat norm]", mgls_solve ,4},
	...
	{"swap",_("Swap data (usefull after Fourier transform)"),"swap Dat 'dir'", mgls_swap ,16},
