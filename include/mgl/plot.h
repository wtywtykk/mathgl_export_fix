...
void mgl_radar(HMGL graph, HCDT a, const char *pen, float r);
...
void mgl_tube_xyz(HMGL graph, HCDT x, HCDT y, HCDT z, float r, const char *pen);
void mgl_tube_xy(HMGL graph, HCDT x, HCDT y, float r, const char *penl);
void mgl_tube(HMGL graph, HCDT y, float r, const char *pen);
/*****************************************************************************/
...
void mgl_radar_(uintptr_t *graph, uintptr_t *a,	const char *pen, float *r, int);
