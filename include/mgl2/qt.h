...
uintptr_t MGL_FEATURES_EXPORT mgl_create_graph_qt_(const char *title, int);
/// Run main Qt loop for event handling.
int MGL_FEATURES_EXPORT mgl_qt_run();
int MGL_FEATURES_EXPORT mgl_qt_run_();
...
class MGL_FEATURES_EXPORT mglQT : public mglWnd
{
