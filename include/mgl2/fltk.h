...
uintptr_t MGL_FEATURES_EXPORT mgl_create_graph_fltk_(const char *title, int);
/// Run main FLTK loop for event handling.
int MGL_FEATURES_EXPORT mgl_fltk_run();
int MGL_FEATURES_EXPORT mgl_fltk_run_();
/// Run main FLTK loop for event handling in separate thread.
int MGL_FEATURES_EXPORT mgl_fltk_thr();
...
class MGL_FEATURES_EXPORT mglFLTK : public mglWnd
{
