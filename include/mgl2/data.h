...
using mglDataA::Momentum;
	...
	inline mglData Detect(mreal lvl, mreal dj) const
	{	return mglData(true,mgl_data_detect(this,lvl,dj));	}
...
/** Noises below lvl amplitude are ignored.
 * Parameter dy \in [0,ny] set the "attraction" distance of points to curve. */
inline mglData mglDetect(const mglDataA &d, mreal lvl, mreal dj)
{	return mglData(true,mgl_data_detect(&d,lvl,dj));	}
//-----------------------------------------------------------------------------
